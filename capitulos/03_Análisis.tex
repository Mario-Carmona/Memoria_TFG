...
R.5 &
\begin{tabular}[c]{@{}l@{}}Solicitud de cambios continuamente por parte del \\ cliente\end{tabular} &
...
\textbf{Muy Bajo} &                          & \cellcolor[HTML]{32CB00} & \cellcolor[HTML]{32CB00} & \cellcolor[HTML]{FCFF2F} & \cellcolor[HTML]{FCFF2F} \\ \hline
\textbf{Bajo}     &                          & \cellcolor[HTML]{32CB00} & \cellcolor[HTML]{FCFF2F} & \cellcolor[HTML]{FCFF2F} & \cellcolor[HTML]{F8A102} \\ \hline
\textbf{Medio}    &                          & \cellcolor[HTML]{FCFF2F} & \cellcolor[HTML]{FCFF2F} & \cellcolor[HTML]{F8A102} & \cellcolor[HTML]{F8A102} \\ \hline
\textbf{Alto}     & \cellcolor[HTML]{FCFF2F} & \cellcolor[HTML]{FCFF2F} & \cellcolor[HTML]{F8A102} & \cellcolor[HTML]{F8A102} & \cellcolor[HTML]{FE0000} \\ \hline
\textbf{Muy Alto} & \cellcolor[HTML]{FCFF2F} & \cellcolor[HTML]{F8A102} & \cellcolor[HTML]{F8A102} & \cellcolor[HTML]{FE0000} & \cellcolor[HTML]{FE0000} \\ \hline
\end{tabular}%
}
